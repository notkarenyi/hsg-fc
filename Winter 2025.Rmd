...
<div style="display:flex;">
  <div class="callout">Overall budget<br />$`r count_x("totalreceived")`</div>
  <div class="callout">Number of organizations<br />`r nrow(summarize(group_by(df,org),n=n()))`</div>
  <div class="callout">Student population<br />1,419</div>
  <div class="callout">Total events<br />`r count_x("eventsactual")`</div>
  <div class="callout">Total attendees<br />`r count_x("attendactual")`</div>
</div>

...
```{r, fig.height = 7}
planned_spending(quarter, caption = "Note: Gold=Planned, Maroon=Actual. Because this graph focuses on HSG funds,\nactual amounts are capped by the amount allocated to each HSO by HSG.")
```

...
```{r, fig.height = 8}
orgs_by_event_type(quarter, caption = "Only HSG funds are considered.")
```
...
```{r, fig.height = 3}
spending_by_event_type(quarter, caption = "Only HSG funds are considered.")
```

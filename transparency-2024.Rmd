...
p <- df %>%
  ...
  ggplot(aes(org,total)) +
  geom_bar(stat="identity",show.legend=F,fill="#800000") +
  labs(title="    Number of Events Planned by Organization, Fall 2024")
...
p <- df %>%
  ...
  geom_bar(stat="identity",show.legend=F,fill="#800000") +
  labs(title="    Total Rollover/External Funds by Organization,\n    Fall 2024")
...
**We need your voice** to determine what types of events we, as the Harris student body, want to fund next quarter. Please fill the following [1-minute form](https://forms.gle/Jq5z4rwTVAKWb9re8) to let us know your opinion.
